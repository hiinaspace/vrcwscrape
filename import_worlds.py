...
async def import_worlds_from_stdin():
    ...
    for i in range(0, len(world_ids), batch_size):
        ...
        print(f"Processed batch {i//batch_size + 1}: {imported} imported, {skipped} skipped")
    
    print(f"Import complete: {total_imported} worlds imported, {total_skipped} already existed")
