...
def test_recent_worlds_parsing():
    ...
    assert world.image_url == "https://api.vrchat.cloud/api/1/file/file_75572866-4841-4704-b148-01fb5a3490b8/12/file"
    assert world.thumbnail_url == "https://api.vrchat.cloud/api/1/image/file_75572866-4841-4704-b148-01fb5a3490b8/12/256"
...
def test_world_detail_parsing():
    ...
    assert world.image_url == "https://api.vrchat.cloud/api/1/file/file_447b6078-e5fb-488c-bff5-432d4631f6cf/2/file"
    assert world.visits == 11302
    assert len(world.unity_packages) == 1
    assert world.unity_packages[0].asset_url == "https://api.vrchat.cloud/api/1/file/file_6b4497d9-0403-4977-b53e-5eff11b6f12e/49/file"
...
def test_discovered_files_from_world_summary():
    ...
    # Check image file
    image_file = next(f for f in files if f.file_type == FileType.IMAGE and "file_75572866" in f.file_id)
...
def test_extract_metrics():
    ...
    expected_keys = ["favorites", "heat", "popularity", "occupants", "private_occupants", "public_occupants", "visits"]
...
def test_stable_metadata():
    ...
    ephemeral_fields = ["favorites", "heat", "popularity", "occupants", "private_occupants", "public_occupants", "visits"]
