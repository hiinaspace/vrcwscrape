...
| --- | --- | --- | --- | --- |
| Curved-shape parcel polygon types | Gap (narrowed 2026-07-01) | Oval at 48-target: 51/59 quad (0.864) vs paper ellipse 124/128 (0.969), measured at HEAD after the corner-derivation fixpoint (0f052ad); the earlier 23-quad evidence was pre-fixpoint | Deferred (2026-07-04, greybox GO reorder — see [greybox-eval.md](greybox-eval.md)) | Revisit if curved island blocks show parcel-quality defects in the in-engine street-level audit; then audit approximate-polygon corner detection on curved parcels vs paper Fig. 2 semantics, then field quality |
| Triangle junction angles | Gap (narrowed 2026-07-01) | junction_angle_dev 16.67° vs paper 2.94° at 48-target at HEAD (pre-fixpoint evidence said 21.7°) | Deferred (2026-07-04, same reorder; likely same root as the row above) | Revisit together with the row above + field fidelity near corners |
